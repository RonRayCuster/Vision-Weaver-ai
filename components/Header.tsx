...
const Header: React.FC<HeaderProps> = ({ onMenuClick, presets, currentPresetId, onPresetChange, onSavePreset, onVideoFileChange }) => {
             ...
             <div className="flex items-center gap-2">
                ...
                />
                 <button 
                    ...
                    title="Load a custom video file"
                ...
                >
                    <span className="text-sm font-medium">Load Video</span>
                </button>
                <button 
